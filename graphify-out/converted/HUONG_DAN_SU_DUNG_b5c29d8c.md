<!-- converted from HUONG_DAN_SU_DUNG.docx -->
...
――――――――――――――――――――――――――――――――――――――――
📋 MỤC LỤC
- [Khởi Động & Đăng Ký/Đăng Nhập Tài Khoản](#1-khởi-động--đăng-kýđăng-nhập-tài-khoản)
- [Thiết Lập API Keys & AI Config](#2-thiết-lập-api-keys--ai-config)
- [Tạo Mới & Quản Lý Môn Học (Subjects)](#3-tạo-mới--quản-lý-môn-học-subjects)
- [Tạo Mới Bài Giảng (Lessons)](#4-tạo-mới-bài-giảng-lessons)
- [Quy Trình 6 Bước Thiết Kế Bài Giảng Chi Tiết (Workflow Editor)](#5-quy-trình-6-bước-thiết-kế-bài-giảng-chi-tiết-workflow-editor)
...
- [Luồng Tạo Video Bài Giảng Hoạt Cảnh Tự Động (Video Generator)](#6-luồng-tạo-video-bài-giảng-hoạt-cảnh-tự-đồng-video-generator)
- [Các Lưu Ý Quan Trọng Khi Sử Dụng](#7-các-lưu-ý-quan-trọng-khi-sử-dụng)
――――――――――――――――――――――――――――――――――――――――
...
- Truy cập vào địa chỉ Frontend của ứng dụng (mặc định tại máy local là http://localhost:3000 hoặc http://localhost:5173).
- Nhấp chọn Đăng ký (Register) trên màn hình.
- Điền đầy đủ thông tin:
- Họ và tên / Tên hiển thị.
- Email (sử dụng để đăng nhập).
- Mật khẩu (tối thiểu 6 ký tự).
- Nhấn Đăng ký để hoàn tất. Hệ thống sẽ tự động đăng ký và dẫn thầy/cô đến trang Đăng nhập.
1.2 Đăng nhập hệ thống (`/login`)
- Nhập Email và Mật khẩu đã đăng ký.
- Nhấn Đăng nhập. Hệ thống sử dụng cơ chế xác thực bảo mật JWT, sau khi đăng nhập thành công thầy/cô sẽ được chuyển hướng trực tiếp về giao diện chính My Subjects (Môn học của tôi).
――――――――――――――――――――――――――――――――――――――――
...
3.1 Tạo môn học mới
- Tại trang chủ, nhấp chọn nút + New Subject (hoặc Tạo môn học).
- Form Tạo môn học mới sẽ hiện ra với các trường thông tin sau:
...
- Nhấn nút Tạo môn học để lưu lại.
...
- 📋 Đề cương (Syllabus): Tạo, nhập và quản lý khung chương trình tổng thể của toàn bộ môn học.
- 📚 Bài giảng (Lessons): Nơi chứa danh sách tất cả các bài học chi tiết của môn học đó.
- 🎬 Video: Nơi quản lý, theo dõi lịch sử sinh các video hoạt cảnh của môn học.
――――――――――――――――――――――――――――――――――――――――
...
- Nhấp nút + Tạo bài giảng.
- Một Modal popup xuất hiện hỗ trợ 2 phương pháp:
...
- Nhấp chọn Tạo & Bắt đầu sửa.
- Hệ thống sẽ ngay lập tức khởi tạo bài giảng ở trạng thái Draft và tự động chuyển hướng thầy/cô vào giao diện Workflow Editor 6 bước chuyên sâu (/lessons/:id).
――――――――――――――――――――――――――――――――――――――――
...
- Nhập nội dung: Gõ hoặc dán (Copy-paste) dàn ý thô của bài giảng vào khung nhập liệu lớn. Thầy/cô có thể định dạng dàn ý theo cấu trúc phân cấp markdown đơn giản.
- Ví dụ nhập liệu:
- Lưu dữ liệu: Bấm nút 💾 Lưu Outline ở góc trên bên phải.
- Khi lưu thành công, nhấn Tiếp theo → ở chân trang để chuyển sang Bước 2.
――――――――――――――――――――――――――――――――――――――――
...
- Tạo kịch bản: Nhấp chọn nút 🤖 Tạo Kịch Bản.
- AI sẽ tự động phân tách bài giảng thành một chuỗi các slide có thứ tự logic gồm: Slide tiêu đề, Slide mục tiêu, các Slide nội dung cốt lõi, Slide tình huống, Slide tóm tắt, v.v.
- Các trường thông tin thiết kế của mỗi Slide:
...
- Sinh hình ảnh minh họa bằng AI:
...
- Lớp 1 - Tạo lời giảng: Nhấp nút ✨ Tạo Lời Giảng để AI viết kịch bản hướng dẫn chi tiết cho từng slide dựa trên nội dung slide.
...
- Cấu hình giọng đọc (TTS Selector):
...
- Ghi âm trực tiếp bằng giọng của giảng viên (Voice Recording):
...
- Chọn mẫu PowerPoint (Template Selector):
...
- Tối ưu hóa hình ảnh & nội dung trang slide:
...
- Đóng gói và tải file PPTX về máy:
...
- Manim Engine: Đối với các slide chứa công thức toán học phức tạp, đồ thị hàm số, biểu đồ thống kê hoặc sơ đồ khối, AI tự động lập trình mã nguồn Python Manim để render ra các hiệu ứng vẽ hình vẽ công thức chuyển động cực kỳ bắt mắt (phong cách giống như kênh Youtube nổi tiếng 3Blue1Brown).
- Playwright Engine: Đối với các bài giảng lập trình hoặc hướng dẫn thao tác phần mềm, hệ thống giả lập một trình duyệt Chromium không đầu, tự động ghi hình lại quá trình gõ từng ký tự code trên màn hình IDE mô phỏng hay gõ lệnh trên Terminal.
- Imagen 3 Engine: Với các slide mô tả ý tưởng trừu tượng cần tính nghệ thuật, AI dùng Imagen 3 để vẽ tranh và áp dụng hiệu ứng camera zoom chuyển động mượt mà.
- Static Engine: Với các slide chứa danh sách chữ đơn giản, hệ thống tạo video tĩnh chất lượng cao kết hợp hiệu ứng Ken Burns nhẹ nhàng để người học không bị mỏi mắt.
6.2 Các bước tạo video bài giảng:
- Cấu hình Video: Điền các tùy chọn trong bảng ConfigPanel:
...
- Bắt đầu tạo video: Nhấn nút 🚀 Tạo Video.
- Theo dõi tiến trình trực quan (ProgressTracker):
