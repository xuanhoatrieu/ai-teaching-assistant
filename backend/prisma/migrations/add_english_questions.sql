-- =======================================================================
-- Migration: Add English Questions Table (Safe for Production)
-- Date: 2026-09-17
--
-- This script is completely safe:
--   ✅ Only uses CREATE TABLE IF NOT EXISTS and IF NOT EXISTS for foreign key
--   ✅ Zero impact on existing tables (lessons, users, review_questions, etc.)
